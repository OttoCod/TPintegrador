...
<head>
    ...
    <title>Compra 3 Veces a la Semana - BlackFit Gym</title>
    <link rel="stylesheet" href="../assets/styles/styles.css">
    <link rel="stylesheet" href="../compra/form.css">
    <link rel="stylesheet" href="../navegation/barranavega.css">
    <link rel="stylesheet" href="../pages/assets/styles/logo.css">
    ...
    <main>
        <section>
            ...
            <form id="purchaseForm" action="procesar_compra.php" method="post">
                ...
                <input type="hidden" name="producto" value="3 Veces a la Semana">
